                ...
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <h5 class="mb-0">Menu Details Access</h5>
                            </div>
                        ...
                        <div class="table-responsive">
							<table id="menu_details_accessTable" class="table table-striped table-bordered" style="width:100%">
								<thead>
									<tr>
...
<script>
    ...
    var menu_details_accessTable = $('#menu_details_accessTable').DataTable({
            "ordering": false,
            "scrollX": true,
            "processing": true,
            "serverSide": true,
            ...
            ajax: {
                url: "<?= base_url() ?>level/ax_data_menu_details_access",
                type: 'POST',
                data: function(d) {
                    return $.extend({}, d, {
                        "id_level": <?= $id_level ?>,
                ...
                //     render: function(data, type, full, meta){
                    ...
                    {data: "nm_menu_details"},
                    {
                        ...
                        render: function(data, type, full, meta){
                            ...
                            return '<input class="form-check-input me-1" type="checkbox" value="" '+str+' onclick="simpanDetail('+full.id_menu_details+','+full.id_menu_details_access+','+data+')"id="detail_'+full.id_menu_details+'">'
                    }
                },
                // {
                //     data: "active",
    ...
    function simpanDetail(id_menu_details, id_menu_details_access, active){
      // alert(id_menu_group);

      if ($('#detail_'+id_menu_details).is(":checked")) {
        var url = "<?= base_url() ?>level/ax_set_details_access";
        var data = {
        ...
        $.ajax({
          ...
          menu_details_accessTable.ajax.reload();
        ...
        var url = "<?= base_url() ?>level/ax_unset_details_access";
        var data = {
            id_menu_details: id_menu_details,
            id_menu_details_access: id_menu_details_access,
            active: active,
